...
**Technological Fellow** @ [Organized Crime and Corruption Reporting Project](https://www.occrp.org/en) (October 2015 - present )<br/>
<u>Responsiblities:</u> Helping journalists communicate securely with their sources. Web scraping. Web development and maintenance. Assisting in server maintenance.<br/>
<u>Projects:</u> [Panama Papers](https://www.occrp.org/en/panamapapers/), [The Khadija Project](https://www.occrp.org/en/corruptistan/azerbaijan/khadijaismayilova/).
...
|:----------|:--------------|:-------|
| [DuckDuckGo](https://duckduckgo.com/) | Suggesting [!bangs](https://duckduckgo.com/bang?q=) and developing instant answers (like [nmap cheatsheet](https://duckduckgo.com/?q=nmap+cheatsheet&t=canonical&ia=cheatsheet)). | Currently Contributing |
...
| [elementary OS](https://elementary.io) | Translating the operating system into Bosnian language. Translating the project website into Bosnian language. Promotion. Contributing changes to the overall look of the project website | No longer contributing |
| [Kompjuteraš](http://kompjuteras.com/) | Writing about IT-related topics in Bosnian language. Promoting open source software. | No longer contributing |
...
| [Open WhisperSystems](https://whispersystems.org/) | Single-handedly translated RedPhone and TextSecure into Serbian language. Managing these translations. | No longer contributing |
...
**Fun bonus fact:** Technically, I was the very first civilian who submitted a pull request to the National Security Agency and [it got accepted](https://github.com/NationalSecurityAgency/SIMP/pull/1).
